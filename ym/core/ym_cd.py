...
def set_region():
    ...
    # 设置全局变量经纬度
    longitude = "104.0850490905795"
    latitude = "30.52729618448312"
...
def cd_execute():
    ...
    while True:
        ...
        logger.info(f"_______________________成都已运行{rounds}次,当前时间{now_date_time}秒__________________________________\n\n")
