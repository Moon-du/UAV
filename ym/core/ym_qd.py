...
def set_region():
    ...
    # 设置全局变量经纬度
    longitude = "104.0849750066537"
    latitude = "30.52717333441327"
...
def qd_execute():
    ...
    while True:
        ...
        logger.info(f"_______________________青岛已运行{rounds}次,当前时间{now_date_time}秒__________________________________\n\n")
